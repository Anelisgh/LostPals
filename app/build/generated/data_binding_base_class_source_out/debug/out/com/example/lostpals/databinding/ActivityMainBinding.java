...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull MenuBinding menu, @NonNull FragmentContainerView navHostFragment) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MenuBinding binding_menu = MenuBinding.bind(menu);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, main, binding_menu,
          navHostFragment);
    }
