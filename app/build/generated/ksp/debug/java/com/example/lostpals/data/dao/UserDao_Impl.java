...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`username`,`email`,`password`,`photoUri`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, User value) {
        ...
        if (value.getPhotoUri() == null) {
          ...
          stmt.bindString(5, value.getPhotoUri());
        }
      }
    };
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`username` = ?,`email` = ?,`password` = ?,`photoUri` = ? WHERE `id` = ?";
      }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpUsername,_tmpEmail,_tmpPassword,_tmpPhotoUri);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getUserById(final long id, final Continuation<? super User> continuation) {
  ...
  @Override
  public Object loginUser(final String email, final String passwordHash,
      final Continuation<? super User> continuation) {
  ...
  @Override
  public Object emailExists(final String email, final Continuation<? super Integer> continuation) {
  ...
  @Override
  public Object emailExistsExcludingUser(final String email, final long excludeUserId,
      final Continuation<? super Integer> continuation) {
    final String _sql = "SELECT COUNT(*) FROM users WHERE email = ? AND id != ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    if (email == null) {
      _statement.bindNull(_argIndex);
    ...
    _argIndex = 2;
    _statement.bindLong(_argIndex, excludeUserId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<Integer>() {
      @Override
      public Integer call() throws Exception {
  ...
  @Override
  public Object usernameExistsExcludingUser(final String username, final long excludeUserId,
      final Continuation<? super Integer> continuation) {
    final String _sql = "SELECT COUNT(*) FROM users WHERE username = ? AND id != ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    if (username == null) {
      _statement.bindNull(_argIndex);
